...
func HandlerWithOptions(si ServerInterface, options GorillaServerOptions) http.Handler {
	...
	r.HandleFunc(options.BaseURL+"/test-header-fixed-nocontent", wrapper.TestHeaderFixedNoContent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-header-nocontent", wrapper.TestHeaderNoContent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ref-header-fixed-nocontent", wrapper.TestRefHeaderFixedNoContent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/test-ref-header-nocontent", wrapper.TestRefHeaderNoContent).Methods("GET")
